// Type definitions for redux-form 6.0.5
// Project: https://github.com/erikras/redux-form
// Definitions based on:
// https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/redux-form 
// b0f7c3beeda79423c690a0080f984963fa9bec23
...
declare module 'redux-form' {
  ...
  export interface IFieldProps extends React.HTMLProps<any> {
    ...
    component: React.Component<any, any> | { (): void; }| string;
    ...
    normalize?: { (value, previousValue, allValues, previousAllValues): any; }
  ...
  export interface IFieldArrayProps extends React.HTMLProps<any> {
    ...
    /**
     * Object with custom props to pass through the FieldArray component into a component provided to component prop.
     * This props will be merged to props provided by FieldArray itself.
     */
    props: any;

  }

  /** The FieldArray component is how you render an array of fields. */
